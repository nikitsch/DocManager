...
import { TaxPeriodLabelMapper, TimeBreakpointsLabelMapper } from '~shared/model/constant';
...
const FilterBar: FC<FilterBarProps> = (props) => {
  ...
  const timeBreakpointsOptions = getSelectOptions(TimeBreakpointsLabelMapper, true);
      ...
      <Stack direction="row" flexWrap="wrap" mt={3} rowGap={2} columnGap={5}>
        ...
        {isAdmin && (
          <FormSelect
            ...
            options={[...usersOptions, ...usersOptions, ...usersOptions, ...usersOptions, ...usersOptions]}
            fullWidth={false}
            blankOptionItem
          />
        )}
